...
const blogImage = "images/it63.jpg";
      ...
      <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          >
            {main.tags.map((tag, i) => (
              <span key={i} style={{
                ...
                color: "white", padding: "4px 12px", borderRadius: 20, fontSize: "0.85rem"
              }}>
                {tag}
              </span>
            ))}
        ...
        <motion.div
          ...
          style={{
            ...
            borderRadius: 12,
            padding: isRTL ? "40px 36px 40px 40px" : 40,
            boxShadow: "var(--shadow)",
            lineHeight: 1.8,
            textAlign: isRTL ? "right" : "left"
          }}
        >
          <p style={{marginBottom: 25, fontSize: 1.1}}>
            {main.intro}
          </p>
          <h2 style={{fontSize: "1.8rem", color: mainHeadingColors[0], marginTop: 35, marginBottom: 20}}>
            {main.cyclesHeading}
          </h2>
          <p>
            {main.cycles}
          </p>
          <h2 style={{fontSize: "1.8rem", color: mainHeadingColors[1], marginTop: 35, marginBottom: 20}}>
            {main.collabHeading}
          </h2>
          <p>
            {main.collab}
          </p>
          <h2 style={{fontSize: "1.8rem", color: mainHeadingColors[2], marginTop: 35, marginBottom: 20}}>
            {main.stabilityHeading}
          </h2>
          <p>
            {main.stability}
          </p>
          <h2 style={{fontSize: "1.8rem", color: mainHeadingColors[3], marginTop: 35, marginBottom: 20}}>
            {main.alignHeading}
          </h2>
          <p>
            {main.align}
