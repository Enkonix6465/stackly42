...
import { useLanguage } from "../context.jsx/LanguageContext"; // use your existing context

const translations = {
  en: {
    pageTitle: "Cloud Infrastructure Solutions",
    heroTitle: "Cloud Infrastructure Solutions",
    heroParagraph: "Delivering scalable, secure, and flexible cloud infrastructure services designed to optimize your IT environment and accelerate your digital transformation journey.",
    heroButton: "Contact Us",
    benefitsSection: "Benefits of Our Cloud Infrastructure Service",
    benefitCards: [
      {
        title: "Scalable Cloud Architecture",
        short: "Effortlessly scale your infrastructure to meet growing business demands.",
        long: "Our cloud solutions adapt dynamically, so you pay only for what you use with high availability."
      },
      {
        title: "Robust Security",
        short: "Protect your cloud assets with industry-leading security protocols.",
        long: "Features like encryption, identity management, and continuous monitoring keep your data safe."
      },
      {
        title: "Optimized Performance",
        short: "Experience fast, reliable cloud infrastructure designed for high availability.",
        long: "Auto-scaling and load balancing ensure smooth application delivery even during traffic spikes."
      },
      {
        title: "Proactive Monitoring",
        short: "Prevent downtime with continuous cloud health checks.",
        long: "Our experts identify and resolve cloud issues before they impact your business."
      },
      {
        title: "Seamless Migration",
        short: "Migrate your workloads with zero downtime and full data protection.",
        long: "We provide full support throughout cloud migration to minimize disruption."
      },
      {
        title: "24/7 Cloud Support",
        short: "Access expert cloud assistance any time, any day.",
        long: "Reduce downtime and resolve issues rapidly with our dedicated support team."
      }
    ],
    whyHeading: "Why Choose Our Cloud Infrastructure?",
    whyParagraph: "We provide scalable, secure, and highly available cloud infrastructure solutions tailored for your business growth.",
    whyBenefits: [
      "Customizable cloud setups tailored to your exact needs",
      "Automated disaster recovery and backup solutions",
      "Cost-efficient resource management and optimization",
      "Advanced analytics for real-time system insights",
      "Expert guidance through every stage of cloud adoption"
    ],
    ...
    sliderVcpu: "vCPU Cores",
    sliderRam: "Memory (GB)",
    sliderStorage: "Storage (GB)",
    costLabel: "Your Estimated Monthly Cost",
  ...
  ar: {
    pageTitle: "حلول البنية التحتية السحابية",
    heroTitle: "حلول البنية التحتية السحابية",
    heroParagraph: "نقدّم خدمات سحابية مرنة وآمنة وقابلة للتوسع لتسريع تحولك الرقمي.",
    heroButton: "اتصل بنا",
    benefitsSection: "مزايا خدمة البنية التحتية السحابية",
    benefitCards: [
      {
        title: "بنية سحابية قابلة للتوسع",
        short: "وسع البنية بسهولة مع نمو المتطلبات.",
        long: "دفع دينامي ות מועדף — تدفع فقط مقابل ما تستخدم مع جاهزية عالية."
      },
      {
        title: "أمان قوي",
        short: "احمِ أصولك بأعلى البروتوكولات الأمنية.",
        long: "تشفير، إدارة هويات، ومراقبة متواصلة لحماية بياناتك."
      },
      {
        title: "أداء محسّن",
        short: "تمتع ببنية تحتية سحابية موثوقة وسريعة.",
        long: "توسعة وتحميل ذكيان لضمان الأداء حتى في الذروة."
      },
      {
        title: "مراقبة استباقية",
        short: "تفادَ الأعطال مع فحوصات صحة سحابية دائمة.",
        long: "نحل المشاكل قبل أن تؤثر في عملك."
      },
      {
        title: "هجرة سلسة",
        short: "نقل الأحمال بلا توقف مع حماية كاملة للبيانات.",
        long: "نرافقك بكل خطوة في عملية الهجرة لتقليل التأثير."
      },
      {
        title: "دعم سحابي 24/7",
        short: "مساعدة خبراء سحاب على مدار الساعة.",
        long: "نضمن الاستجابة الفورية وتقليل زمن التوقف."
      }
    ],
    whyHeading: "لماذا تختار البنية التحتية السحابية لدينا؟",
    whyParagraph: "حلول معمارية مرنة وآمنة وقابلة للتوسع تدفع نمو أعمالك.",
    whyBenefits: [
      "إعدادات سحابية مخصصة حسب احتياجك",
      "استعادة تلقائية ونسخ احتياطي",
      "إدارة موارد اقتصادية محسّنة",
      "تحليلات متقدمة ورؤية فورية",
      "دعم مختص في جميع المراحل"
    ],
    whyButton: "ابدأ الآن",
    galleryTitle: "معرض أعمال البنية السحابية",
    gallerySubtitle: "نستعرض مشاريع أنجزناها في قطاعات متنوعة.",
    costHeading: "تقدير تكلفة السحابة",
    costSub: "استخدم أداتنا التفاعلية لحساب تقدير فوري لاحتياجاتك.",
    sliderVcpu: "أنوية vCPU",
    sliderRam: "الذاكرة (GB)",
    sliderStorage: "التخزين (GB)",
    costLabel: "تكلفتك الشهرية التقديرية",
    costBtn: "اتصل بنا لعرض سعر مخصص",
    ctaHeading: "جاهز لبناء موقعك؟",
    ctaParagraph: "تواصل معنا اليوم لنبدأ مشروعك ونعزز حضورك الإلكتروني.",
    ctaStart: "ابدأ مشروعك",
    ctaLearn: "اعرف المزيد عنا"
  },
  he: {
    pageTitle: "פתרונות תשתית ענן מקצועיים",
    heroTitle: "פתרונות תשתית ענן",
    heroParagraph: "שירותי ענן גמישים, מאובטחים ומותאמים שמצמיחים כל עסק ומזרזים את הדיגיטל שלכם.",
    heroButton: "צור קשר",
    benefitsSection: "היתרונות של שירות תשתית הענן שלנו",
    benefitCards: [
      {
        title: "תשתית ענן גמישה",
        short: "התאמה קלה של התשתית ככל שהעסק גדל.",
        long: "משלמים רק על צריכה בפועל — הענן מתאים את עצמו ודואג לזמינות גבוהה."
      },
      {
        title: "אבטחת מידע מתקדמת",
        short: "הגנה על נכסים בענן בסטנדרטים הגבוהים ביותר.",
        long: "הצפנה, ניהול זהויות וניטור מתמשך לכלל המידע."
      },
      {
        title: "ביצועים מיטביים",
        short: "מהירות, אמינות וזמינות גבוהה לכל השירותים.",
        long: "הרחבה ודינמיות גם בעומסי שיא."
      },
      {
        title: "ניטור מובנה",
        short: "זיהוי וטיפול בתקלות לפני שהן משפיעות.",
        long: "הצוות שלנו מזהה תקלות מראש ודואג לרציפות."
      },
      {
        title: "הגירה חלקה לענן",
        short: "מעבר חלק וללא עצירות עם שמירה מלאה.",
        long: "ליווי מלא בכל תהליך ההגירה לעסק המשכי."
      },
      {
        title: "תמיכת ענן 24/7",
        short: "סיוע מקצועי תמידי בענן.",
        long: "צוות התמיכה מגיב מהר ומפחית השבתות."
      }
    ],
    whyHeading: "למה לבחור בתשתית הענן שלנו?",
    whyParagraph: "אנו מספקים פתרונות ענן מאובטחים, קלים להתרחבות וחסכוניים, מותאמים לצמיחה.",
    whyBenefits: [
      "פריסות ענן מותאמות בדיוק לצורך שלך",
      "הגנה ושרידות אוטומטית והעתקי גיבוי",
      "התייעלות וחסכון בניהול המשאבים",
      "אנליטיקה חכמה לזיהוי מהיר",
      "ליווי מקצועי לאורך כל הדרך"
    ],
    whyButton: "להתחלה",
    galleryTitle: "פורטפוליו תשתית ענן",
    gallerySubtitle: "מבחר אתרים שפתחנו וניהלנו במגזרי תעשייה שונים.",
    costHeading: "הערכת עלות תשתית ענן",
    costSub: "השתמש במחשבון שלנו להערכה שקופה ומהירה עבור העסק.",
    sliderVcpu: "ליבות vCPU",
    sliderRam: "זיכרון (GB)",
    sliderStorage: "אחסון (GB)",
    costLabel: "העלות החודשית המשוערת",
    costBtn: "צור קשר להצעת מחיר",
    ctaHeading: "מוכן להקים אתר בענן?",
    ctaParagraph: "התחל איתנו עוד היום ובנה נוכחות אונליין יציבה ומתקדמת.",
      ...
      <div className="home-page">
        ...
        <section className="hero-section">
          <video autoPlay muted loop playsInline className="hero-bg-video">
            <source src="images/videoss4 copy.mp4" type="video/mp4" />
            ...
            {t.benefitCards.map((card, i) => (
              ...
              >
                <div className="flex items-center justify-center w-16 h-16 rounded-full bg-white/20 text-white mb-6 transform group-hover:scale-110 transition-transform">
                  <span style={{ fontSize: 26, fontWeight: 'bold' }}>{i + 1}</span>
                </div>
            ...
            <div className="grid-2">
              ...
              >
                <div className="benefits-image">
                  <img src="images/it38.jpg" alt="Cloud Infrastructure Visual" />
                </div>
              </motion.div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-4">
                    <input type="range" id="vcpu-slider" min="1" max="64" value={vcpu}
                ...
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-4">
                    <input type="range" id="ram-slider" min="1" max="128" value={ram}
                ...
                <div className="group bg-[var(--card-bg)] dark:bg-[#2d3748] p-6 rounded-xl shadow-lg hover:shadow-[var(--shadow-hover)] transition-all duration-300">
                  ...
                  <div className="flex items-center space-x-4">
                    <input type="range" id="storage-slider" min="10" max="2000" value={storage}
